...
Arguments
    ...
    -m, --mode=             Specify a mode. Write ONLY the shorthand. If spaces are
                            included, put it in quotes. The default is all modes. Works
                            only when classic is selected.

{str_modes}
    -a, --map=              Specify a map. If spaces are included, put it in quotes.
                            The default is all maps.

{str_maps}
    -r, --region=           Specify a region. If spaces are included, put it in quotes.
...
# Long options
long_options = ["help", "game=", "players=", "mode=","map=","region="]
